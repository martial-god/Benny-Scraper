...
namespace BennyScraper.DataAccess.Migrations
{
    ...
    [Migration("20260107075124_RemoveObsoleteChapterRangeColumns")]
    partial class RemoveObsoleteChapterRangeColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BennyScraper.Models.Chapter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("BennyScraper.Models.ChapterRange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.ToTable("chapter_range", (string)null);
                });

            modelBuilder.Entity("BennyScraper.Models.Configuration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("BennyScraper.Models.Novel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("BennyScraper.Models.NovelList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BennyScraper.Models.Page", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("BennyScraper.Models.Chapter", b =>
                {
                    b.HasOne("BennyScraper.Models.Novel", "Novel")
                        .WithMany("Chapters")
            ...
            modelBuilder.Entity("BennyScraper.Models.Page", b =>
                {
                    b.HasOne("BennyScraper.Models.Chapter", "Chapter")
                        .WithMany("Pages")
